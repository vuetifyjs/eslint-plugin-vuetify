...
const replacements = {
  ...
  VListItemAvatar: { custom: '`v-list-item` with `avatar` props, or put an avatar in the append or prepend slot' },
  VListItemContent: false,
  VListItemIcon: { custom: '`v-list-item` with `icon` props, or put an icon in the append or prepend slot' },
  VOverflowBtn: false,
  VPicker: false,
